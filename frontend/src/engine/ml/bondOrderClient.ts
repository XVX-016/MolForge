...
import type { BondOrderResponse, MLRequest } from "../../types/ml";

export async function predictBondOrders(state: MLRequest) {
    ...
    try {
        ...
        res.bondOrders.forEach((bo: BondOrderResponse["bondOrders"][number]) => {
